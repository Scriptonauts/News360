...
const category = [
  ...
  },
  {
    name: "Politics",
    image:
      "https://static.politico.com/dims4/default/c668351/2147483647/strip/true/crop/1160x773+0+0/resize/630x420!/quality/90/?url=https%3A%2F%2Fstatic.politico.com%2F1f%2F47%2F3d7eb66148da9abc5bb66f990a08%2F220310-joe-biden-ap-773.jpg",
  },
  {
    name: "Asia",
    image:
  ...
  education: [
    {
      ...
      image:
        "https://cdn.cnn.com/cnnnext/dam/assets/210714095430-tusimple-truck-blue-exlarge-169.jpg",
      time: "1 minute ago",
      category: "Tech",
    },
    {
...
class FeedSegment extends React.Component<any, any> {
  ...
  componentDidMount() {
    ...
    const segmentsData = segments.map((cateItem: any) => {
      this.catIds.push(cateItem.id);
      return (
        <IonSegmentButton
          key={cateItem.id}
          value={cateItem.id}
          onClick={this.props.segmentHandler}
        >
